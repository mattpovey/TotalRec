        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            if transcript.hasTimedSegments {
                TranscriptSegmentBrowser(
                    ...
                    subtitle: "Play timed segments, verify wording, and save clip-level text corrections without changing speaker assignments here.",
        ...
        VStack(alignment: .leading, spacing: 12) {
            VStack(alignment: .leading, spacing: 4) {
                Text("Find and Replace")
                    .font(.headline)
                Text("Apply literal, case-sensitive replacements across the whole transcript without touching speaker labels.")
                    .font(.footnote)
        ...
        VStack(alignment: .leading, spacing: 12) {
            VStack(alignment: .leading, spacing: 4) {
                Text("Selected Segment")
                    .font(.headline)
                Text("Playback and text editing stay attached to the clip you selected.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
            }
        ...
        VStack(alignment: .leading, spacing: 12) {
            VStack(alignment: .leading, spacing: 4) {
                Text("Transcript Editing")
                    .font(.headline)
                Text("This transcript does not include timed segments, so text is edited as a single document.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
            }
